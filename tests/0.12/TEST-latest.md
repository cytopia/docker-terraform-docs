...
| network | The network | `object` | <code><pre>{<br>  "subnets": [<br>    {<br>      "cidr_block": "10.0.0.0/16",<br>      "id": "vpc-123456"<br>    }<br>  ],<br>  "vpc": {<br>    "cidr_block": "10.0.0.0/16",<br>    "id": "vpc-123456"<br>  }<br>}<br></pre></code> | no |
